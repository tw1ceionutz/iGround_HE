                ...
                <main class="tm-col-right">
                    <section class="tm-content">
                       ...
                       if($view == '1'){
                            ...
                            echo '<h2 class="mb-5 tm-content-title">Irigatia este pornita</h2>';
                        }
                        #echo $output;
                        $view = $_GET['view'];
                        #echo 'view='.$view;
                        if($view == '3'){
                            echo '<h2 class="mb-5 tm-content-title">Pompa este pornita</h2>';
                            $output = shell_exec('snmpset -v 1 -c private  192.168.0.100 iso.3.6.1.4.1.17095.3.3.0 int 0');
                        }
                        #echo $output;
                        return;
                        ?>
