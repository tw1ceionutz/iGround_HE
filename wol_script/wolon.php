...
<title>iGround page</title>    <link href="../iground/https://fonts.googleapis.com/css?family=Open+Sans:300,400" rel="stylesheet" />
        ...
        <div>
            ...
            <div class="tm-row">
                ...
                <main class="tm-col-right">
                    ...
                    <meta http-equiv="refresh" content="10;URL=../iground/wol.php">
                        <?php
                            ...
                            $output = $rez;
                            echo $output;
                            $rez2 =  $ssh->exec('/log error "wol mac=58:20:b1:41:b4:ab"');
                            $output = $rez2;
                            echo $output;
                            return;
                        ?>
